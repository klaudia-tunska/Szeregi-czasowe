...
```{r dane,echo = F}
data = read.csv('C:/Users/klaud/Documents/Szeregi czasowe/rowery.csv', sep = ';')
...
plot(ts-sez, xlab="Rok", ylab="Wartosc")
lines(ts2-trend2, col='green')
legend("topleft", 
       legend = c('1. Trend, 2. Sezonowość', '1. Sezonowość, 2. Trend'), 
       col = c('black', 'green'),pch=20, title = 'Kolejność usuwania')
